...
class SubmissionsController < ApplicationController
  ...
  def create
    @user = User.find(session[:user_id])
    @course = Course.fin(params[:course_id])
    @homework = Homework.fin(params[:homework_id])
    ...
    grading_result = JavaExecutor.new(abs_path_file, "/Users/Zhen/Desktop/input", "/Users/Zhen/Desktop/output").execute
    #sleep 5
