...
class AnnouncementsControllerTest < ActionController::TestCase
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post :create, announcement: { announcement_description: @announcement.announcement_description, course_id: @announcement.course_id }
    end
  ...
  test "should update announcement" do
    patch :update, id: @announcement, announcement: { announcement_description: @announcement.announcement_description, course_id: @announcement.course_id }
    assert_redirected_to announcement_path(assigns(:announcement))
  end
