...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { hw_description: @homework.hw_description, hw_due_time: @homework.hw_due_time, hw_name: @homework.hw_name, hw_release_time: @homework.hw_release_time, hw_test_case_dir: @homework.hw_test_case_dir }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { hw_description: @homework.hw_description, hw_due_time: @homework.hw_due_time, hw_name: @homework.hw_name, hw_release_time: @homework.hw_release_time, hw_test_case_dir: @homework.hw_test_case_dir }
    assert_redirected_to homework_path(assigns(:homework))
  end
